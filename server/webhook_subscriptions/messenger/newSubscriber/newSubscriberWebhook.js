...
exports.newSubscriberWebhook = (payload) => {
  if (!payload.entry[0].messaging[0].prior_message && !payload.entry[0].messaging[0].message.attachments && !payload.entry[0].messaging[0].postback && !payload.entry[0].messaging[0].delivery) {
